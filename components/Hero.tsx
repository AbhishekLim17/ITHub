  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 bg-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-blue-50 via-white to-yellow-50"></div>
        <div className="absolute top-20 right-20 w-96 h-96 bg-gradient-to-br from-[#F3C600]/20 to-[#0066FF]/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 left-20 w-96 h-96 bg-gradient-to-br from-[#00B4D8]/20 to-[#F3C600]/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fadeIn">
            <div className="inline-block">
              <span className="inline-block px-4 py-2 bg-gradient-to-r from-[#F3C600] to-[#0066FF] text-white text-sm font-semibold rounded-full shadow-lg">
            ...
            <div className="space-y-4">
              <h1 className="text-6xl lg:text-7xl font-heading font-bold text-[#111827] leading-tight">
                Innovative
                <br />
                <span className="bg-gradient-to-r from-[#0066FF] via-[#00B4D8] to-[#F3C600] bg-clip-text text-transparent">
                  IT-Lösungen
                </span>
                <br />
                für Ihr Business
            ...
            <div className="flex flex-wrap gap-4">
              <a href="/#contact" className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-[#0066FF] to-[#00B4D8] text-white font-semibold rounded-2xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                Kostenlose Beratung
                <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" size={20} />
              </a>
              <a href="/#services" className="inline-flex items-center px-8 py-4 bg-white text-[#111827] font-semibold rounded-2xl shadow-lg hover:shadow-xl border-2 border-[#E5E7EB] hover:border-[#0066FF] transform hover:-translate-y-1 transition-all duration-300">
                Unsere Leistungen
              </a>
            </div>
          ...
          <div className="relative hidden lg:block">
            <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-500">
              <div className="aspect-[4/3] bg-gradient-to-br from-[#0066FF] via-[#00B4D8] to-[#F3C600] flex items-center justify-center p-12">
            ...
            {/* Floating Elements */}
            <div className="absolute -top-6 -right-6 w-32 h-32 bg-[#F3C600] rounded-full blur-2xl opacity-60 animate-pulse"></div>
            <div className="absolute -bottom-6 -left-6 w-40 h-40 bg-[#00B4D8] rounded-full blur-2xl opacity-60 animate-pulse" style={{ animationDelay: '1.5s' }}></div>
          </div>
        </div>
      </div>
    </section>
